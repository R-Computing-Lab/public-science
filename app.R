  ...
  sidebarLayout(
    ...
    mainPanel(
     ...
     to examine how predictors relate to willingness to participate in different research types."
            ...
            strong("Citation: "),
            "O’Connor, S.M., Garrison, S.M. Who is Willing to Participate in Genetic Research? Exploring Barriers and Predictors. Behavior Genetics (2025).", 
            tags$a(href = " https://doi.org/10.1007/s10519-025-10243-z", " https://doi.org/10.1007/s10519-025-10243-z")
          ),p(
            strong("Important: "),
